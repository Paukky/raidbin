...
const SunriseSabbath = [
  {
    ...
    description: (
      <>
        ...
        1. <b className='text-text-tank'>Tanks</b> and <b className='text-text-healer'>Healers</b> will start North-West counter-clockwise when finding their respective cannon to bait.
        <br/>
        2. <b className='text-text-dps'>DPS</b> will start North-East clockwise when finding their respective cannon to bait.
        <br/>
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <br/>
        2. Short debuffs(23s) will bait the cannon while standing on the coloured dot and following the priority system mentioned in Slide 1
        <br/>
      </>
      ),
    ...
    <div>
            ...
            <div className='text-center'>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 grid-rows-2 gap-4 max-w-screen-lg ">
                    <div class=" min-h-fit bg-white border border-gray-200 rounded-lg shadow my-2 bg-text-900">
                            <img class="rounded-t-lg"  src={M4position} alt="m1 clock position" />
                        <div class="sm:p-3">
                                <h5 class="m-2 text-xl sm:text-2xl font-bold tracking-tight text-gray-900 bg-">Witch Hunt Position</h5>
                            <p class="mb-3 px-1">These are the position when baiting the divekick</p>        
                        </div>
                    </div>
                    <div class=" min-h-fit bg-white border border-gray-200 rounded-lg shadow my-2 bg-text-900">
                            <img class="rounded-t-lg"  src={M4witchhunt} alt="m1 clock position" />
                        <div class="sm:p-3">
                                <h5 class="m-2 text-xl sm:text-2xl font-bold tracking-tight text-gray-900 bg-">Witch Hunt Position #2</h5>
                            <p class="mb-3 px-1"><b className='text-text-healer'>Healers</b> and <b className='text-text-dps'>Melee</b> swap their clock position to avoid tight AOE-Overlaps
                            Supports will be baiting first dive then DPS.<br/> <b>[THMR] or [HTRM]</b></p>        
                        </div>
                    </div>
                    <div class="bg-white border border-gray-200 rounded-lg shadow my-2 bg-text-900">
                            <img class="rounded-t-lg" src={M4transition} alt='m1 pair position'/>
                        <div class="sm:p-3">
                                <h5 class="m-2 text-xl sm:text-2xl font-bold tracking-tight ">Position for Transition</h5>
                            <p class="mb-3 px-1">Since Wicked Thunder will always face south here. Your position will be flipped vertically to give melee positional access</p>        
                        </div>
                    </div>
                    <div class=" border border-gray-200 rounded-lg shadow my-2 bg-text-900">
                        <img class="rounded-t-lg"  src={M4ee2} alt="Dps bait at Intercardinal First"/>
                        <div class="sm:p-3">
                            <h5 class="m-2 text-xl sm:text-2xl font-bold tracking-tight ">Shaba EE2</h5>
                            <p class=" mb-3 px-1">DPS will be the first role group to bait the cleaves</p>        
                        </div>
                    </div>
                    <div class=" border border-gray-200 rounded-lg shadow my-2 bg-text-900">
                        <img class="rounded-t-lg"  src={M4midnight} alt="Midnight Sabbath Position"/>
                        <div class="sm:p-3">
                            <h5 class="m-2 text-xl sm:text-2xl font-bold tracking-tight ">Midnight Sabbath Position</h5>
                            <p class=" mb-3 px-1">These are the position for Midnight Sabbath. Pairs rotate counter-clockwise from their intercardinal position</p>        
                        </div>
                    </div>
        ...
        <div>
          <div className="flex flex-col items-center justify-center  w-full  sm:px-5 bg-gradient-to-b from-primary-950 to-primary-400">
                ...
                <p className="text-xl"><i>Uptime Sunrise</i></p>
